...
(deftest take-test
  ...
  (is (= '(1 2 3 3 4 5 6 7 8 9)
         (update (*>> (take 3)) inc (range 10))))
  (is (= '(0 0 0 3 4 5 6 7 8 9)
         (assoc (*>> (take 3)) 0 (range 10)))))

(deftest periscope-composition
  (is (= '(0 42 2 42 4 42 6 7 8 9)
         (assoc (*>> (filter odd?) (take 3)) 42 (range 10))))
  (is (= '(0 42 2 3 4 5 6 7 8 9)
         (assoc (*>> (take 3) (filter odd?)) 42 (range 10))))
  (is (= '(0 1 2 3 4 5 6 7 42 9)
         (assoc (*>> (filter even?) last) 42 (range 10)))))
